...
class Pattern(str, Enum):
    ...
    REMOVED_TEST_FUNCTION_PROTOTYPE = "-([ \t]*)(public)([ \t\n\r]*)([a-zA-Z0-9<>._?, ]+)([ \t\n\r]*)test([a-zA-Z0-9_]+)" \
                                      "([ \t\n\r]*)\\("
    REMOVED_TEST_FUNCTION_PROTOTYPE2 = "-([ \t]*)@Test(.*?)([ \t\n\r]*)(-([ \t]*)@(.*?)([ \t\n\r]*))*-([ \t]*)(public)([ \t\n\r]*)([a-zA-Z0-9<>._?, ]+)([ \t\n\r]*)([a-zA-Z0-9_]+)" \
                                      "([ \t\n\r]*)\\("
    REFACTORED_TEST_FUNCTION_PROTOTYPE = "-([ \t]*)(public)([ \t\n\r]*)([a-zA-Z0-9<>._?, ]+)([ \t\n\r]*)test([a-zA-Z0-9_]+)" \
                                            "([ \t\n\r]*)\\([a-zA-Z0-9<>\\[\\]._?, \t\n\r]*\\)([ \t\n\r]*)([a-zA-Z0-9_ ,\\-\t\n\r]*)\\{?" \
                                            "([a-zA-Z0-9_ ,\\-\t\n\r]*)\\+"
    REFACTORED_TEST_FUNCTION_PROTOTYPE2 = "-([ \t]*)@Test(.*?)([ \t\n\r]*)(-([ \t\n\r]*)@(.*?)([ \t\n\r]*))*-([ \t]*)(public)([ \t\n\r]*)([a-zA-Z0-9<>._?, ]+)([ \t\n\r]*)([a-zA-Z0-9_]+)" \
                                      "([ \t\n\r]*)\\([a-zA-Z0-9<>\\[\\]._?, \n]*\\)([ \t\n\r]*)([a-zA-Z0-9_ ,\\-\t\n\r]*)\\{?" \
                                    "([a-zA-Z0-9_ ,\\-\t\n\r]*)\\+"
    ADDED_TEST_FUNCTION_PROTOTYPE = "\\+([ \t]*)(public)([ \t]*)([a-zA-Z0-9<>._?, ]+)([ \t\n\r]*)test([a-zA-Z0-9_]+)" \
                                    "([ \t\n\r]*)\\("
    ADDED_TEST_FUNCTION_PROTOTYPE2 = "\\+([ \t\n\r]*)@Test(.*?)([ \t\n\r]*)(\\+([ \t]*)@(.*?)([ \t\n\r]*))*\\+([ \t]*)(public)([ \t\n\r]*)([a-zA-Z0-9<>._?, ]+)([ \t\n\r]*)([a-zA-Z0-9_]+)" \
                                      "([ \t\n\r]*)\\("                                
    REMOVED_ASSERT_FUNCTION_PROTOTYPE = "-([ \t]*)assert([a-zA-Z0-9_]+)([ \t\n\r]*)\\("
